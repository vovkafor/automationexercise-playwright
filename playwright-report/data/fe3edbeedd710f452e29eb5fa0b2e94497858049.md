...
- Name: home.spec.ts >> Home page >> newsletter subscription works
- Location: tests/home.spec.ts:18:7
...
Call log:
  - waiting for locator('#subscribe')
    - locator resolved to <button type="submit" id="subscribe" class="btn btn-default">…</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="fc-footer-buttons-container">…</div> from <div class="fc-consent-root">…</div> subtree intercepts pointer events
...
- generic [ref=e1]:
  ...
  - contentinfo [ref=e798]:
    - generic [ref=e803]:
      ...
      - generic [ref=e805]:
        - textbox "Your email address" [ref=e806]: testsubscribe_demo@gmail.com
  ...
  - link "" [ref=e814] [cursor=pointer]:
    - /url: "#top"
    - generic [ref=e815]: 
  - dialog "This site asks for consent to use your data" [active] [ref=e819]:
    - generic [ref=e821]:
      - generic [ref=e822]:
        - paragraph [ref=e824]: Welcome
        - heading "This site asks for consent to use your data" [level=1] [ref=e825]
      - list [ref=e827]:
        - listitem [ref=e828]:
          - img [ref=e831]
          - generic [ref=e833]: Personalised advertising and content, advertising and content measurement, audience research and services development
        - listitem [ref=e834]:
          - img [ref=e837]
          - generic [ref=e839]: Store and/or access information on a device
      - button "Learn more" [ref=e840] [cursor=pointer]:
        - img [ref=e843]
        - generic [ref=e845]: Learn more
      - generic [ref=e846]:
        - paragraph [ref=e847]:
          ...
          - button "List of partners." [ref=e848] [cursor=pointer]
        - paragraph [ref=e849]: Some vendors may process your personal data on the basis of legitimate interest, which you can object to by managing your options below. Look for a link at the bottom of this page or in the site menu to manage or withdraw consent in privacy and cookie settings.
    - generic [ref=e852]:
      - button "Consent" [ref=e853] [cursor=pointer]:
        - paragraph [ref=e855]: Consent
      - button "Manage options" [ref=e856] [cursor=pointer]:
        - paragraph [ref=e858]: Manage options
```
...
```ts
  ...
  6  |   readonly navProducts: Locator;
  7  |   readonly navCart: Locator;
  8  |   readonly navSignup: Locator;
  9  |   readonly navLogout: Locator;
  10 |   readonly subscribeEmail: Locator;
  11 |   readonly subscribeButton: Locator;
  12 |   readonly subscribeSuccess: Locator;
  13 | 
  14 |   constructor(page: Page) {
  15 |     this.page             = page;
  16 |     this.logo             = page.locator('#header a.navbar-brand');
  17 |     this.navProducts      = page.locator('a[href="/products"]');
  18 |     this.navCart          = page.locator('a[href="/view_cart"]');
  19 |     this.navSignup        = page.locator('a[href="/login"]');
  20 |     this.navLogout        = page.locator('a[href="/logout"]');
  21 |     this.subscribeEmail   = page.locator('#susbscribe_email');
  22 |     this.subscribeButton  = page.locator('#subscribe');
  23 |     this.subscribeSuccess = page.locator('#success-subscribe');
  24 |   }
  25 | 
  26 |   async goto() {
  ...
  28 |   }
  29 | 
  30 |   async subscribe(email: string) {
  31 |     await this.subscribeEmail.fill(email);
> 32 |     await this.subscribeButton.click();
     |                                ^ Error: locator.click: Test timeout of 30000ms exceeded.
  33 |   }
  34 | }
  35 | 
