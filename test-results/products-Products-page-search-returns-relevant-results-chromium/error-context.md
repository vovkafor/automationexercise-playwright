...
- Name: products.spec.ts >> Products page >> search returns relevant results
...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <p>Some vendors may process your personal data on th…</p> from <div class="fc-consent-root">…</div> subtree intercepts pointer events
    ...
    - scrolling into view if needed
    - done scrolling
    - <p>…</p> from <div class="fc-consent-root">…</div> subtree intercepts pointer events
...
- generic [ref=e1]:
  ...
  - generic [ref=e38]:
    ...
    - textbox "Search Product" [ref=e40]: T-Shirt
  ...
  - link "" [ref=e761] [cursor=pointer]:
    - /url: "#top"
    - generic [ref=e762]: 
  - dialog "This site asks for consent to use your data" [active] [ref=e766]:
    - generic [ref=e768]:
      - generic [ref=e769]:
        - paragraph [ref=e771]: Welcome
        - heading "This site asks for consent to use your data" [level=1] [ref=e772]
      - list [ref=e774]:
        - listitem [ref=e775]:
          - img [ref=e778]
          - generic [ref=e780]: Personalised advertising and content, advertising and content measurement, audience research and services development
        - listitem [ref=e781]:
          - img [ref=e784]
          - generic [ref=e786]: Store and/or access information on a device
      - button "Learn more" [ref=e787] [cursor=pointer]:
        - img [ref=e790]
      ...
      - generic [ref=e793]:
        - paragraph [ref=e794]:
          ...
          - button "List of partners." [ref=e795] [cursor=pointer]
        - paragraph [ref=e796]: Some vendors may process your personal data on the basis of legitimate interest, which you can object to by managing your options below. Look for a link at the bottom of this page or in the site menu to manage or withdraw consent in privacy and cookie settings.
    - generic [ref=e799]:
      - button "Consent" [ref=e800] [cursor=pointer]:
        - paragraph [ref=e802]: Consent
      - button "Manage options" [ref=e803] [cursor=pointer]:
        - paragraph [ref=e805]: Manage options
```
...
```ts
  ...
  8  |   readonly firstAddToCart: Locator;
  9  |   readonly continueShoppingButton: Locator;
  10 |   readonly viewCartLink: Locator;
  11 | 
  12 |   constructor(page: Page) {
  13 |     this.page                  = page;
  14 |     this.searchInput           = page.locator('#search_product');
  15 |     this.searchButton          = page.locator('#submit_search');
  16 |     this.productCards          = page.locator('.productinfo');
  17 |     this.firstAddToCart        = page.locator('.productinfo').first().locator('a.add-to-cart').first();
  18 |     this.continueShoppingButton= page.locator('button:has-text("Continue Shopping")');
  19 |     this.viewCartLink          = page.locator('a:has-text("View Cart")');
  20 |   }
  21 | 
  22 |   async goto() {
  ...
  24 |   }
  25 | 
  26 |   async searchProduct(term: string) {
...
> 28 |     await this.searchButton.click();
  ...
  32 |     await this.firstAddToCart.click();
